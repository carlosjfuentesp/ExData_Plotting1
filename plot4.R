...
## SubPlot 1
plot(d1$Date_time, d1$Global_active_power, type="l", xlab="", ylab="Global Active Power")

## SubPlot 2
plot(d1$Date_time, d1$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=c(1,1), col=c("black","red","blue"), cex=0.75, pt.cex=1, bty="n") 

## SubPlot 4
plot(d1$Date_time, d1$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()
